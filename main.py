...
with open('encoded_self.data.json','r') as encode_file:
    encoded_self.data = json.load(encode_file)
...
user_input[2] = encoded_self.data['fuel_type'][fuel_type]
user_input[3] = encoded_self.data['aspiration'][aspiration]
user_input[4] = encoded_self.data['num_of_doors'][num_of_doors]
...
user_input[5] = encoded_self.data['engine_location'][engine_location]
...
user_input[11] = encoded_self.data['num_of_cylinders'][num_of_cylinders]
